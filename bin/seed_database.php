...
use Symfony\Component\PasswordHasher\Hasher\UserPasswordHashsherInterface;
...
return function (array $context) {
    ...
    $em->getConnection()->executeStatement('DELETE FROM product');
    $em->getConnection()->executeStatement('DELETE FROM category');
    $em->getConnection()->executeStatement('DELETE FROM `user`');
    $em->getConnection()->executeStatement('ALTER TABLE product AUTO_INCREMENT = 1');
    $em->getConnection()->executeStatement('ALTER TABLE category AUTO_INCREMENT = 1');
    $em->getConnection()->executeStatement('ALTER TABLE `user` AUTO_INCREMENT = 1');
    ...
    $hashedPassword = $passwordHasher->hashPassword($manager, 'manager123');
    ...
    echo "  Email: admin@technova.com\n";
    echo "  Password: admin123\n\n";
    echo "Manager Credentials:\n";
    echo "  Email: manager@technova.com\n";
    echo "  Password: manager123\n\n";
    echo "Products and categories have been inserted successfully!\n";
};
